...
NA12877_TR_p <- read_TR_Platinum("/Platinum/NA12877/VarSCAT_chr",".txt")
NA12878_TR_p <- read_TR_Platinum("/Platinum/NA12878/VarSCAT_chr",".txt")
HG002_TR_p <- read_TR_Platinum("/GIAB/HG002/VarSCAT_chr",".txt")
HG003_TR_p <- read_TR_Platinum("/GIAB/HG003/VarSCAT_chr",".txt")
HG004_TR_p <- read_TR_Platinum("/GIAB/HG004/VarSCAT_chr",".txt")
HG005_TR_p <- read_TR_Platinum("/GIAB/HG005/VarSCAT_chr",".txt")
HG006_TR_p <- read_TR_Platinum("/GIAB/HG006/VarSCAT_chr",".txt")
HG007_TR_p <- read_TR_Platinum("/GIAB/HG007/VarSCAT_chr",".txt")
