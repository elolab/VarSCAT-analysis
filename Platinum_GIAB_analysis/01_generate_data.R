...
NA12877_TR_p <- read_TR_Platinum("NA12877.txt")
NA12878_TR_p <- read_TR_Platinum("NA12878.txt")
HG002_TR_p <- read_TR_Platinum("HG002.txt")
HG003_TR_p <- read_TR_Platinum("HG003.txt")
HG004_TR_p <- read_TR_Platinum("HG004.txt")
HG005_TR_p <- read_TR_Platinum("HG005.txt")
HG006_TR_p <- read_TR_Platinum("HG006.txt")
HG007_TR_p <- read_TR_Platinum("HG007.txt")
