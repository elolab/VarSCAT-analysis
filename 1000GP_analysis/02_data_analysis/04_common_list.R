...
{
  print(item)
  file_open_name <- paste0("/TR_Tag/","chr",item,"_results_df_2.txt")
  ...
  EAS_TR_P <- c(EAS_TR_P,file_TR_P[file_TR_P[,3]>0,8])
  EUR_TR_P <- c(EUR_TR_P,file_TR_P[file_TR_P[,4]>0,8])
  AFR_TR_P <- c(AFR_TR_P,file_TR_P[file_TR_P[,5]>0,8])
  AMR_TR_P <- c(AMR_TR_P,file_TR_P[file_TR_P[,6]>0,8])
  SAS_TR_P <- c(SAS_TR_P,file_TR_P[file_TR_P[,7]>0,8])
  file_non_TR_P <- file_common[file_common[,1]==1|file_common[,1]==2|file_common[,1]==3,]
  EAS_non_TR_P <- c(EAS_non_TR_P,file_non_TR_P[file_non_TR_P[,3]>0,8])
  EUR_non_TR_P <- c(EUR_non_TR_P,file_non_TR_P[file_non_TR_P[,4]>0,8])
  AFR_non_TR_P <- c(AFR_non_TR_P,file_non_TR_P[file_non_TR_P[,5]>0,8])
  AMR_non_TR_P <- c(AMR_non_TR_P,file_non_TR_P[file_non_TR_P[,6]>0,8])
  SAS_non_TR_P <- c(SAS_non_TR_P,file_non_TR_P[file_non_TR_P[,7]>0,8])
