...
{
  file_name <- paste0("./03_TR_proportion/Results/output_a",item,".txt")
...
p <- p + scale_x_discrete(labels=unique(sample_population2$Population))
p <- p + expand_limits(y=c(0.062, 0.0765))
figure_name2 <- paste0("S2_Fig.tif")
