...
p1 <- ggVennDiagram(TR.list_d,label_percent_digit = 1, label = "percent",label_size = 2, label_alpha = 0,set_size = 3)
p1 <- p1 + scale_fill_distiller(palette = "Reds", direction = 1)
tiff(filename ="legend.tif",width = 80,height = 80, res=300,units = "mm")
p1
dev.off()
