...
VarSCAT_results_perfect <- read.table("revision_100_HG006_chr1_site.txt",
...
tiff("Upset_HG006_100.tiff",width = 140,height = 70,res = 300, units = "mm")
upset(fromList(z), order.by = "freq",point.size=2.0,line.size = 0.5,text.scale = 0.75, number.angles = 0,
      set_size.show = T,set_size.scale_max = 30000,
