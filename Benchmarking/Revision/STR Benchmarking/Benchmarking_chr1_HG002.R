...
Krait_SSR <- get_id("HG002.Krait.perfect.hg38_multianno.vcf")
TRF_UCSC_100 <- get_id("HG002_chr1.TRF.UCSC_100_match.hg38_multianno.vcf")
RM_UCSC_100 <- get_id("HG002_chr1.RM.UCSC_100_match.hg38_multianno.vcf")

GATK_file <- paste0("GATK_HG002_chr1_TR.vcf")
...
VarSCAT_results_perfect <- read.table("revision_100_HG002_chr1_site.txt",
...
z = list("GATK TandemRepeat"=GATK_id,"VarSCAT"=VarSCAT_results_ID_perfect, "UCSC RepeatMasker"=RM_UCSC_100,
         "UCSC TRF"=TRF_UCSC_100,"Krait"=Krait_SSR)
tiff("Upset_HG002_100.tiff",width = 140,height = 70,res = 300, units = "mm")
upset(fromList(z), order.by = "freq",point.size=2.0,line.size = 0.5,text.scale = 0.75, number.angles = 0,
      set_size.show = T,set_size.scale_max = 42000,
