...
Krait_90 <- get_id("HG002.Krait.90.hg38_multianno.vcf")
TRF_UCSC_90 <- get_id("HG002.TRF.90.hg38_multianno.vcf")
RM_UCSC_90 <- get_id("HG002.RM.90.hg38_multianno.vcf")
...
VarSCAT_results_perfect <- read.table("revision_90_HG002_chr1_site.txt",
...
tiff("Upset_HG002_90.tiff",width = 140,height = 70,res = 300, units = "mm")
upset(fromList(z), order.by = "freq",point.size=2.0,line.size = 0.5,text.scale = 0.65, number.angles = 0,
      set_size.show = T,set_size.scale_max = 50000,
