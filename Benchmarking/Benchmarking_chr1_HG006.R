...
Krait_SSR <- get_id("~/VarSCAT_analysis/Benchmarking/Krait/HG006.Krait.perfect.hg38_multianno.vcf")
TRF_perfect <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG006_chr1.TRF.perfect.hg38_multianno.vcf")
TRF_UCSC <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG006_chr1.TRF.UCSC.hg38_multianno.vcf")
RM_UCSC <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG006_chr1.RM.UCSC.hg38_multianno.vcf")
TRF_UCSC_100 <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG006_chr1.TRF.UCSC_100_match.hg38_multianno.vcf")
RM_UCSC_100 <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG006_chr1.RM.UCSC_100_match.hg38_multianno.vcf")

GATK_file <- "~/VarSCAT_analysis/Benchmarking/GATK/GATK_HG006_chr1_TR.vcf"
...
VarSCAT_results_perfect <- read.table("~/VarSCAT_analysis/Platinum_GIAB_analysis/GIAB/HG006/VarSCAT_chr1.txt",
