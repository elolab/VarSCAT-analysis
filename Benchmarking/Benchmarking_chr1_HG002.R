...
Krait_SSR <- get_id("~/VarSCAT_analysis/Benchmarking/Krait/HG002.Krait.perfect.hg38_multianno.vcf")
TRF_perfect <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG002_chr1.TRF.perfect.hg38_multianno.vcf")
TRF_UCSC <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG002_chr1.TRF.UCSC.hg38_multianno.vcf")
RM_UCSC <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG002_chr1.RM.UCSC.hg38_multianno.vcf")
TRF_UCSC_100 <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG002_chr1.TRF.UCSC_100_match.hg38_multianno.vcf")
RM_UCSC_100 <- get_id("~/VarSCAT_analysis/Benchmarking/TRF_RepeatMasker/HG002_chr1.RM.UCSC_100_match.hg38_multianno.vcf")

GATK_file <- "~/VarSCAT_analysis/Benchmarking/GATK/GATK_HG002_chr1_TR.vcf"
...
VarSCAT_results_perfect <- read.table("~/VarSCAT_analysis/Platinum_GIAB_analysis/GIAB/HG002/VarSCAT_chr1.txt",
...
tiff("vennDiagram_HG002.tiff",width = 70,height = 70,res = 300, units = "mm")
...
tiff("vennDiagram_HG002_100.tiff",width = 70,height = 70,res = 300, units = "mm")
