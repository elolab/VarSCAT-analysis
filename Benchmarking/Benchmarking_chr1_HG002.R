...
TRF_perfect <- get_id("HG002_chr1.TRF.perfect.hg38_multianno.vcf")
TRF_UCSC <- get_id("HG002_chr1.TRF.UCSC.hg38_multianno.vcf")
RM_UCSC <- get_id("HG002_chr1.RM.UCSC.hg38_multianno.vcf")
...
GATK_file <- "GATK_HG002_chr1_TR.vcf"
